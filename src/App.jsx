  ...
  return (
    <div className="parent">
      {jobOpenings.map(function(elem,idx){
        ...
        return <div key={idx}>
              <Card company={elem.nameOfCompany} post={elem.post} tag1={elem.tag1} tag2={elem.tag2} dateposted={elem.datePosted} pay={elem.pay} brandLogo={elem.brandLogo} applyLink={elem.applyLink}/>
        </div>
      })}
    </div>
  )
